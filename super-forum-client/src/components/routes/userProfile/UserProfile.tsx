...
const UserProfile = () => {
  //  useReducer hook: is particularly useful when you have complex state logic that involves multiple sub-values or when the next state depends on the previous state. 
  const [
  ...
  // hook used to grab the user from the Redux store
  ...
  // use to get user threads on load of route / page
  useEffect(() => {
